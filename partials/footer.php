<footer class="ae-container-fluid rk-footer ">
  <div class="ae-grid ae-grid--collapse">
    ...
    <div class="ae-grid__item item-lg-4 au-xs-ta-center">
      ...
      <a href="#0" class="rk-social-btn "><svg><use xlink:href="assets/img/symbols.svg#icon-twitter"></use></svg></a>
      <a href="#0" class="rk-social-btn "><svg><use xlink:href="assets/img/symbols.svg#icon-pinterest"></use></svg></a>
    </div>
